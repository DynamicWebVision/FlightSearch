...
(function() {
    ...
    angular
        .module('app')
        .controller('OrdersController', ContactController);

    function ContactController(Merchant, $timeout, UtilityService) {
        var vm = this;
        ...
        function deleteAdmEmailDialog(admin_email , indx) {
        ...
        function editEditAdminEmailDialog(admin_email , index) {
            vm.edit_admin_email = admin_email;
        ...
        //Opens the Dialog to Delete an Email
        function deleteAdminPhoneDialog(admin_phone , indx) {
        ...
        function confirmDeleteAdminPhone() {
            Merchant.delete('delete_admin_phone',delete_admin_phone.id).then(function(response) {
                ...
                $("#delete-admin-phone-modal").modal('toggle');
            });
        }
        ...
        function editAdminPhoneDialog(admin_phone , index) {
            vm.edit_admin_phone = admin_phone;
